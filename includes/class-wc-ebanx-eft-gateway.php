...
class WC_Ebanx_Eft_Gateway extends WC_Ebanx_Redirect_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->id                   = 'ebanx-eft';
        $this->icon                 = apply_filters('wc_ebanx_eft_icon', false);
        $this->has_fields           = true;
        $this->method_title         = __('EBANX - EFT', 'woocommerce-ebanx');
        $this->method_description   = __('Accept EFT payments using EBANX.', 'woocommerce-ebanx');
        $this->view_transaction_url = 'https://dashboard.ebanx.com/#/transactions/%s';

        $this->init_form_fields();

        $this->title          = 'EFT';
        $this->description    = 'EFT description';
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            'enabled'        => array(
                ...
                'type'    => 'checkbox',
                'label'   => __('Enable EBANX EFT', 'woocommerce-ebanx'),
                'default' => 'no',
            ),
            'integration'    => array(
