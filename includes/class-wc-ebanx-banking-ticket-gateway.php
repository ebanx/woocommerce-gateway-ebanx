<?php
/**
 * Ebanx.com Banking Ticket gateway
 *
...
/**
 * WC_Ebanx_Banking_Ticket_Gateway class.
 *
...
class WC_Ebanx_Banking_Ticket_Gateway extends WC_Ebanx_Gateway {
	...
	public function __construct() {
		...
		// add_action( 'woocommerce_api_wc_ebanx_banking_ticket_gateway', array( $this, 'ipn_handler' ) );
	}
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title' => array(
				...
				'desc_tip'    => true,
				'default'     => __( 'Banking Ticket', 'woocommerce-ebanx' ),
			),
			'description' => array(
				...
				'desc_tip'    => true,
				'default'     => __( 'Pay with Banking Ticket', 'woocommerce-ebanx' ),
			),
			'integration' => array(
