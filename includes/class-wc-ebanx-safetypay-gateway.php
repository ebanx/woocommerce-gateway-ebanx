...
class WC_Ebanx_Safetypay_Gateway extends WC_Ebanx_Redirect_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->icon                 = apply_filters('wc_ebanx_safetypay_icon', false);
        $this->has_fields           = true;
        $this->method_title         = __('EBANX - Safetypay', 'woocommerce-ebanx');
        $this->method_description   = __('Accept Safetypay payments using EBANX.', 'woocommerce-ebanx');
        $this->view_transaction_url = 'https://dashboard.ebanx.com/#/transactions/%s';

        $this->init_form_fields();

        $this->title          = 'Safetypay';
        $this->description    = 'Safetypaydescription';
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            'enabled'        => array(
                ...
                'type'    => 'checkbox',
                'label'   => __('Enable EBANX Safetypay', 'woocommerce-ebanx'),
                'default' => 'no',
            ),
            'integration'    => array(
