...
<div class="banking-ticket__actions">
	<div class="ebanx-button--group ebanx-button--group-two">
		<a href="<?php echo $url_pdf; ?>" target="_blank" class="button banking-ticket__action">Guardar como PDF</a><a href="<?php echo $url_print; ?>" target="_blank" class="button banking-ticket__action">Imprimir OXXO</a>
	</div>
</div>
<hr>
