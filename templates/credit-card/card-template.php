...
<p class="form-row form-row-first">
    ...
    <input id="ebanx-card-expiry" class="input-text wc-credit-card-form-card-expiry" type="text" autocomplete="off" placeholder="<?php esc_html_e('MM / YY', 'woocommerce-gateway-ebanx');?>" style="font-size: 1.5em; padding: 8px;" />
</p>
<p class="form-row form-row-last">
    <label for="ebanx-card-cvv"><?php esc_html_e('Card Code', 'woocommerce-gateway-ebanx');?> <span class="required">*</span></label>
    <input id="ebanx-card-cvv" class="input-text wc-credit-card-form-card-cvv" type="text" autocomplete="off" placeholder="<?php esc_html_e('CVV', 'woocommerce-gateway-ebanx');?>" style="font-size: 1.5em; padding: 8px;" />
</p>
<div class="clear"></div>
...
<p class="form-row form-row-last">
    <label for="ebanx-save-credit-card">
        ...
        <?php esc_html_e('Save this Credit Card on My Account for future orders', 'woocommerce-gateway-ebanx');?>
    </label>
</p>
<div class="clear"></div>
