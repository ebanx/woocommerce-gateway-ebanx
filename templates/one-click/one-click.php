...
<?php if ( $should_show_button ) : ?>
	<form class="ebanx-one-click-form" id="ebanx-one-click-form" method="post" action="<?php echo esc_attr$permalink; ?>">
					...
					<div class="ebanx-one-click-cards">
						<?php foreach ( $cards as $key => $card ) : ?>
							<label class="ebanx-one-click-card">
								<input type="radio" class="ebanx-one-click-card-radio" name="ebanx-one-click-token" value="<?php echo esc_attr( $card->token ); ?>" <?php echo 0 === $i ? 'checked="checked"' : ''; ?> />
