...
<div class="error">
	<p><strong><?php esc_html_e( 'WooCommerce EBANX Gateway', 'woocommerce-gateway-ebanx' ); ?></strong> <?php esc_html_e( 'depends on the last version of WooCommerce to work!', 'woocommerce-gateway-ebanx' ); ?></p>
