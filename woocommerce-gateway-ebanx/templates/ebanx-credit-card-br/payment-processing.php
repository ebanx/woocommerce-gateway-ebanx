...
<?php if ($instalments_number > 1) : ?>
    <p class="ebanx-payment-type"><?php echo $instalments_number ?> <?php _e('parcelas de', 'woocommerce-gateway-ebanx') ?> <?php echo $order_currency ?> <?php echo $instalments_amount ?></p>
<?php else : ?>
