...
<div id="ebanx-debit-cart-form" class="ebanx-payment-container ebanx-language-es">
	...
	<div id="ebanx-container-new-debit-card">
		<section class="ebanx-form-row">
			<label for="ebanx-debit-card-holder-name"><?php echo 'Titular de la tarjeta'; ?> <span class="required">*</span></label>
			<input id="ebanx-debit-card-holder-name" class="wc-credit-card-form-card-name input-text" type="text" autocomplete="off" />
		</section>
		<section class="ebanx-form-row">
			<label for="ebanx-debit-card-number"><?php echo 'Número de la tarjeta'; ?> <span class="required">*</span></label>
		...
		<section class="ebanx-form-row ebanx-form-row-first">
			<label for="ebanx-debit-card-expiry"><?php echo 'Fecha de expiración (MM / AA)'; ?> <span class="required">*</span></label>
		...
		<section class="ebanx-form-row ebanx-form-row-last">
			<label for="ebanx-debit-card-cvv"><?php echo 'Código de verificación'; ?> <span class="required">*</span></label>
