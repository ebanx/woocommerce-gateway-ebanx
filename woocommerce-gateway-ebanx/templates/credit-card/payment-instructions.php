...
<?php } else { ?>
<p><?php printf(wp_kses(__('%1$s, your payment is on the way. Wait for a mail confirmation at %2$s.', 'woocommerce-gateway-ebanx'), array('strong' => array())), '<strong>'.esc_html(ucwords($username)).'</strong>', '<strong>'.esc_html($useremail).'</strong>');?></p>
<?php } ?>
